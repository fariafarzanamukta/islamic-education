        ...
        <div className="ourservice">
            ...
            <div className="container">
                <div className="ourservice-info">
                    ...
                    <CardGroup>
                        <Card>
                            <Card.Img variant="top" className="ourserice-img w-100 h-50" src="https://media.istockphoto.com/photos/muslim-man-is-praying-in-mosque-picture-id1001021150?k=20&m=1001021150&s=612x612&w=0&h=6IQjNNZzZUKdz5COrH4P3Yj1QakFytxZcxMKUXIz02A=
                " />
                            <Card.Body>
                        ...
                        <Card>
                            <Card.Img variant="top" className="ourservice-img w-100 h-50" src="https://media.istockphoto.com/vectors/vector-islam-kuran-ramadan-islamic-arabic-symbolism-vector-id1169856943?k=20&m=1169856943&s=612x612&w=0&h=2nEEXOJpwZwfkaTz7t1qLTPWAJtazmJjkEmYK4K-svs=" />
                            <Card.Body>
